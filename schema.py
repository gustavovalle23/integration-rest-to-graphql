...
from definitions.product_department import (
    ProductSearch as ProductSearchDepartment
)
from definitions.store import Store
from rest.company import get_data_company_from_rest
from rest.product_department import get_data_product_department_from_rest
...
class Query:
    ...
    @strawberry.field
    def listing_department(
        loja_id: int, departamento_id: int
    ) -> ProductSearchDepartment:
        return get_data_product_department_from_rest(loja_id, departamento_id)
